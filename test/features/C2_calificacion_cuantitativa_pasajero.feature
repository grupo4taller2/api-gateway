@now
Feature: C1 Calificación cuantitativa de un pasajero
      Como pasajero quiero poder realizar una calificación cuantitativa
      de un pasajero para así poder brindar mi opinión de este.
  
  Scenario: C1.1 Calificacion de un pasajero por un chofer
    ...
    When como chofer 'mateo' califico al pasajero 'lazaro' con 3 estrellas
    
    Then la calificacion promedio del pasajero 'lazaro' es 3.0
  
  Scenario: C1.2 Calificacion de un pasajero por dos choferes
    Given No hay usuarios registrados
      And Quiero registrarme como chofer con usuario 'mateo'
      And quiero registrarme como chofer con email 'mateo@mateo.com'
      And quiero registrarme como chofer con nombre 'Mateo'
      ...
      And Quiero registrarme como chofer con usuario 'lazaro'
      And quiero registrarme como chofer con email 'lazaro@lazaro.com'
      And quiero registrarme como chofer con nombre 'Lazaro'
      And quiero registrarme como chofer con apellido 'Calvo'
      And quiero registrarme como chofer con telefono '+54111555555555'
      And quiero registrarme como chofer con ubicacion preferida 'Av. Paseo Colón 850, Buenos Aires'
      And quiero registrar patente del auto "BBB 321"
      And quiero registrar fabricante del auto "Audi"
      And quiero registrar modelo del auto "TT"
      And quiero registrar año de fabricación del auto 2022
      And quiero registrar color del auto "Gris"
      And me registro como chofer 'lazaro'
    ...
    When como chofer 'lazaro' califico al pasajero 'joaquin' con 4 estrellas
      And como chofer 'mateo' califico al pasajero 'joaquin' con 5 estrellas
    
    Then la calificacion promedio del pasajero 'joaquin' es 4.5 
